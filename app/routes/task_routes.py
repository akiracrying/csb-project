...
def get_task(task_id):
    ...
    # --- VULN: FLAW 2 - Broken Access Control (no team membership check) ---
    # missing check — any authenticated user can access any task by ID
    # --- END VULN: FLAW 2 ---
    
    # --- FIX: FLAW 2 - Broken Access Control (uncomment this block to fix) ---
